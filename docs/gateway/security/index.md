...
- Canvas host: `/__propaiclaw__/canvas/` and `/__propaiclaw__/a2ui/` (preferred), plus legacy aliases `/__openclaw__/canvas/` and `/__openclaw__/a2ui/` (arbitrary HTML/JS; treat as untrusted content)
