...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.PROPAICLAW_STATE_DIR = "/tmp/openclaw-cli-state";
    process.env.PROPAICLAW_CONFIG_PATH = "/tmp/openclaw-cli-state/openclaw.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        PROPAICLAW_PROFILE: "dev",
        PROPAICLAW_STATE_DIR: "/tmp/openclaw-daemon-state",
        PROPAICLAW_CONFIG_PATH: "/tmp/openclaw-daemon-state/openclaw.json",
