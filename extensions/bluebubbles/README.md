...
This directory contains the **BlueBubbles external channel plugin** for Propaiclaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `Propaiclaw/plugin-sdk` helpers.
