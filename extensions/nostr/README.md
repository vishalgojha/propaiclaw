...
Nostr DM channel plugin for Propaiclaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Propaiclaw. It enables your bot to:
...
```bash
Propaiclaw plugins install @Propaiclaw/nostr
```
...
# Configure Propaiclaw to use local relay
