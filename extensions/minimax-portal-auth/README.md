# MiniMax OAuth (Propaiclaw plugin)
...
```bash
Propaiclaw plugins enable minimax-portal-auth
```

Restart the Gateway after enabling.

```bash
Propaiclaw gateway restart
```

## Authenticate

```bash
Propaiclaw models auth login --provider minimax-portal --set-default
```
