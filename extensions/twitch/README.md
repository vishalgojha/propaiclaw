...
Twitch channel plugin for Propaiclaw.

## Install (local checkout)

```bash
Propaiclaw plugins install ./extensions/twitch
```

## Install (npm)

```bash
Propaiclaw plugins install @Propaiclaw/twitch
```
...
See https://docs.Propaiclaw.ai/channels/twitch for:
