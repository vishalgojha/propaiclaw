...
export const zh_CN: TranslationMap = {
  ...
  chat: {
    ...
    hideCronSessions: "隐藏代理任务会话",
    showCronSessions: "显示代理任务会话",
    showCronSessionsHidden: "显示代理任务会话 (已隐藏 {count} 个)",
  ...
  cron: {
    templates: {
      ...
      listingBroadcast: {
        title: "房源广播",
        subtitle: "将最新房源发布到已批准的 WhatsApp 群组。",
        name: "房源广播",
        description: "以清晰、经纪人友好的格式分享新库存。",
        prompt: "整理最新房源，生成精简的 WhatsApp 更新，包含价格、面积和关键亮点。",
      },
      buyerMatchAlerts: {
        title: "买家匹配提醒",
        subtitle: "快速找到买家需求匹配并通知经纪人。",
        name: "买家匹配提醒",
        description: "持续将新需求与在售房源进行匹配。",
        prompt: "扫描新的买家需求，匹配在售房源，并给出高置信匹配及匹配原因。",
      },
      leadFollowup: {
        title: "线索跟进计划",
        subtitle: "根据高热度和中热度线索生成今日跟进队列。",
        name: "线索跟进计划",
        description: "按紧急程度优先安排回访和 WhatsApp 跟进。",
        prompt: "回顾线索对话，按紧急程度排序，并生成今天清晰的跟进行动列表。",
      },
      groupEngagement: {
        title: "群组互动脉冲",
        subtitle: "基于在售房源建议有价值的群组内容。",
        name: "群组互动脉冲",
        description: "在不刷屏的前提下保持经纪群活跃。",
        prompt: "基于在售库存起草一条价值优先的群组更新，并附上简短行动号召。",
      },
      staleLeadRescue: {
        title: "沉寂线索挽回",
        subtitle: "识别不活跃线索并建议重新触达消息。",
        name: "沉寂线索挽回",
        description: "挽回初次意向后沉默的线索。",
        prompt: "识别近期未回复的线索，提出个性化重触达消息，并优先级排序高潜线索。",
      },
      weeklyDigest: {
        title: "每周经纪摘要",
        subtitle: "发送每周房源、线索和匹配总结。",
        name: "每周经纪摘要",
        description: "面向一个或多个经纪人的管理摘要。",
        prompt: "总结本周：新房源、高意向线索、匹配结果以及建议的下一步行动。",
      },
    },
    summary: {
      enabled: "已启用",
