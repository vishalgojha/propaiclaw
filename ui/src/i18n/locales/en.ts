...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    notes: {
      ...
      cronTitle: "Agent task reminders",
  ...
  chat: {
    ...
    hideCronSessions: "Hide agent task sessions",
    showCronSessions: "Show agent task sessions",
    showCronSessionsHidden: "Show agent task sessions ({count} hidden)",
  ...
  cron: {
    templates: {
      ...
      subtitle: "Pick a ready task and customize details in seconds.",
      apply: "Use template",
      schedule: {
        ...
        daily10am: "Daily 10:00",
        monday8am: "Mon 08:00",
      },
      listingBroadcast: {
        title: "Listing Broadcast",
        subtitle: "Publish latest listings to approved WhatsApp groups.",
        name: "Listing Broadcast",
        description: "Share fresh inventory with clean, broker-friendly formatting.",
        prompt:
          "Gather the newest listings and prepare a concise WhatsApp-ready update with price, area, and key highlights.",
      },
      buyerMatchAlerts: {
        title: "Buyer Match Alerts",
        subtitle: "Find buyer requirement matches and notify the broker quickly.",
        name: "Buyer Match Alerts",
        description: "Continuously match new requirements against active inventory.",
        prompt:
          "Scan incoming buyer requirements, match against active listings, and post high-confidence matches with why they fit.",
      },
      leadFollowup: {
        title: "Lead Follow-up Plan",
        subtitle: "Build the day’s follow-up queue from hot and warm leads.",
        name: "Lead Follow-up Plan",
        description: "Prioritize callbacks and WhatsApp follow-ups by urgency.",
        prompt:
          "Review lead conversations, rank leads by urgency, and create a clear follow-up action list for today.",
      },
      groupEngagement: {
        title: "Group Engagement Pulse",
        subtitle: "Suggest useful group content from active listings.",
        name: "Group Engagement Pulse",
        description: "Keep brokerage groups active without spamming.",
        prompt:
          "Draft one value-first group update from active inventory and include a short call-to-action for interested buyers.",
      },
      staleLeadRescue: {
        title: "Stale Lead Rescue",
        subtitle: "Detect inactive leads and suggest a re-engagement message.",
        name: "Stale Lead Rescue",
        description: "Recover leads that went silent after initial interest.",
        prompt:
          "Identify leads with no recent reply, propose a personalized re-engagement message, and prioritize highest potential leads.",
      },
      weeklyDigest: {
        title: "Weekly Broker Digest",
        subtitle: "Send a weekly summary of listings, leads, and matches.",
        name: "Weekly Broker Digest",
        description: "Management summary for one or many brokers.",
        prompt:
          "Summarize the week: new listings, high-intent leads, match outcomes, and recommended next actions for brokers.",
      },
    },
    summary: {
      enabled: "Enabled",
    ...
    form: {
      ...
      channel: "Channel",
      webhookPlaceholder: "https://example.com/agent-task",
      ...
      exactTimingHelp: "Run on exact schedule boundaries with no spread.",
